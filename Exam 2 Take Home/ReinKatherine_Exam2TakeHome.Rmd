...
fit_totem_pcinc_EKC = lm(CO2 ~ I(pc_income^2), data)
...
# Polynomial Model
fit_totem_pcinc_GDP_totengcon = lm(CO2 ~ I(pc_income^2) + GDP + tot_energyconsump, data)
summary(fit_totem_pcinc_GDP_totengcon)
our_aic = AIC(fit_totem_pcinc_GDP_totengcon)
print(our_aic)
...
# Model including only total emissions and per capita income (EKC)
# added in quadratic using https://www.spsanderson.com/steveondata/posts/2023-11-17/index.html
fit_ei_pcinc_EKC = lm(energyintensity ~ I(pc_income^2), data)
...
# Polynomial Model
fit_ei_pcinc_GDP_totengcon = lm(energyintensity ~ I(pc_income^2) + GDP + tot_energyconsump, data)
summary(fit_ei_pcinc_GDP_totengcon)
our_aic = AIC(fit_ei_pcinc_GDP_totengcon)
print(our_aic)
```
