...
# Graph
plot(effort, Total_Revenue, type = "l", lwd = 2, col = "red", ylim = range(Total_Revenue), xlim = range(effort), main = "Revenues and Costs", xlab = "Effort", ylab = "Revenue")
lines(effort, Total_Cost, type = "l", lwd = 2, col = "purple")
lines(effort, Profit, type = "l", lwd = 2, col = "blue")
legend("bottomright", legend = c("Revenue","Cost","Profit"), col = c("red","purple","blue"), lwd = c(2,2,2))
```
...
# Graph
plot(effort, Total_Revenue, type = "l", lwd = 2, col = "red", ylim = range(Total_Revenue), xlim = range(effort), main = "Revenues and Costs (10% Subsidy)", xlab = "Effort", ylab = "Revenue")
lines(effort, Total_Cost, type = "l", lwd = 2, col = "purple")
lines(effort, Profit, type = "l", lwd = 2, col = "blue")
legend("bottomright", legend = c("Revenue","Cost","Profit"), col = c("red","purple","blue"), lwd = c(2,2,2))
```
...
# Graph
plot(effort, Total_Revenue, type = "l", lwd = 2, col = "red", ylim = range(Total_Revenue), xlim = range(effort), main = "Revenues and Costs (Catchability Increase)", xlab = "Effort", ylab = "Revenue")
lines(effort, Total_Cost, type = "l", lwd = 2, col = "purple")
lines(effort, Profit, type = "l", lwd = 2, col = "blue")
legend("bottomright", legend = c("Revenue","Cost","Profit"), col = c("red","purple","blue"), lwd = c(2,2,2))
```
