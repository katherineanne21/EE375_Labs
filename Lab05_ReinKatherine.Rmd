...
```{r}
plot(x = NULL,y = NULL, main = "Concentration vs. Time for Finite", ylab = "Concentration (g/cm)", xlab = "Time (s)", ylim = range(C_matrix2), xlim = range(time_2))
...
plot(x = NULL,y = NULL, main = "Concentration vs. Time (both)", ylab = "Concentration (g/cm)", xlab = "Time (s)", ylim = range(C_matrix2), xlim = range(time_2))

# Part A lines
lines(Time, C_matrix[1,], type = 'l', col = 2)
